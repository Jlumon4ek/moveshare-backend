...
// @Router       /payment/cards/{cardId}/default [patch]
func SetDefaultCard(paymentService service.PaymentService) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Устанавливаем карту как default
		err = paymentService.SetDefaultPaymentMethod(c.Request.Context(), userID, cardID)
		if err != nil {
