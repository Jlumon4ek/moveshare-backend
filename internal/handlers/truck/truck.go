...
// 	json.NewEncoder(w).Encode(dto.TruckResponse{Truck: truck})
// }
...
// 	w.Header().Set("Content-Type", "application/json")
// 	json.NewEncoder(w).Encode(dto.TrucksResponse{Trucks: trucks})
// }
...
// 	w.Header().Set("Content-Type", "application/json")
// 	json.NewEncoder(w).Encode(dto.TruckResponse{Truck: existingTruck})
// }
